...
sed -i 's,#command\[check_mem\]=/usr/lib64/nagios/plugins/check_mem.sh \$ARG1\$,commannd\[check_mem\]=/usr/lib64/nagios/plugins/check_mem.sh -w 80 -c 90,g' /etc/nagios/nrpe.cfg
#restart the nrpe
